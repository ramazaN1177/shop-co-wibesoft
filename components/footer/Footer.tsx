    ...
    <footer className="bg-[#F0F0F0] pt-36 pb-12 mt-40 relative font-satoshi w-full">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-16 mt-20 lg:mt-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-8 pb-12 border-b border-black/10">
          {/* Brand & Social */}
          <div className="flex flex-col gap-6 max-w-[248px]">
            <Link href="/">
              <Image
            ...
            <p className="text-sm text-black/60 leading-snug font-satoshi mt-2">
              We have clothes that suits your style and which you're proud to wear. From women to men.
            </p>
            <div className="flex items-center gap-3">
              {/* Social Icons Placeholders */}
              <a href="#" className="w-7 h-7 bg-white rounded-full border border-black/20 flex items-center justify-center hover:bg-black hover:text-white transition-colors text-black">
              ...
              <a href="#" className="w-7 h-7 bg-black text-white rounded-full border border-black/20 flex items-center justify-center hover:bg-black/80 transition-colors">
          ...
          {/* Links Grid */}
          <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-8 pt-1">
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-black tracking-[3px] text-sm uppercase leading-none">COMPANY</h3>
              <ul className="flex flex-col gap-3 text-black/60 text-sm">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-black tracking-[3px] text-sm uppercase leading-none">HELP</h3>
              <ul className="flex flex-col gap-3 text-black/60 text-sm">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-black tracking-[3px] text-sm uppercase leading-none">FAQ</h3>
              <ul className="flex flex-col gap-3 text-black/60 text-sm">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-black tracking-[3px] text-sm uppercase leading-none">RESOURCES</h3>
              <ul className="flex flex-col gap-3 text-black/60 text-sm">
